...
def main():
    ...
    parser.add_argument("--model_type", default='bart', type=str, required=False,
                        help="Model type selected in the list: " + ", ".join(MODEL_CLASSES.keys()))
    parser.add_argument("--model_name_or_path", default="facebook/bart-large-cnn", type=str, required=False,
    ...
    parser.add_argument("--scheduler", default='exponential', type=str, #warmup
    ...
    parser.add_argument("--max_summary_length", default=256, type=int,
    ...
    # data directory
    parser.add_argument("--data_dir", default='../data_epfl_news', type=str,
    ...
    parser.add_argument("--checkpoint", default="../results/20220329_134140/model/epoch_2/", type=str,
    ...
    eval_dataset, _ = load_and_cache_examples(args, model.tokenizer, evaluate=True)
    ...
    # test & get report
    args.logger.info("Loading last mode and start testing:")
    output_path = '/mlodata1/blinova/Factual-Error-Correction/results/20220412_141657/model'
    output_path = os.path.join(output_path, 'epoch_'+str(args.num_epochs-1))
    model.load_weights(output_path)
    model.test(eval_dataloader, epoch=args.num_epochs-1)
    # for epoc in range(10):
    #     output_path = '/mlodata1/blinova/Factual-Error-Correction/results/20220322_150130/model'
    #     output_path = os.path.join(output_path, 'epoch_'+str(epoc))
    #     model.load_weights(output_path)
    #     model.test(eval_dataloader, epoch=epoc)
