...
def main():
    ...
    parser.add_argument("--model_name_or_path", default="facebook/bart-base", type=str, required=False,
    ...
    train_dataset, _ = load_and_cache_examples(args, model.tokenizer, evaluate=False)
    ...
    output_path = os.path.join(args.model_dir, 'epoch_'+str(args.num_epochs-1))
