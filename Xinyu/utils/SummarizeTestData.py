...
# -- end fix path --
from preprocessor import yield_lines, get_data_filepath, yield_sentence_pair,tokenize,TURKCORPUS_DATASET, WIKI_DOC, WIKI_DOC_Small,WIKI_DOC_MATCH, WIKI_DOC_CLEAN, D_WIKI, D_WIKI_SMALL, D_WIKI_CLEAN, D_WIKI_MATCH
...
for ps in phases:
    ...
    save_complex_summary_path = get_data_filepath(WIKI_DOC_MATCH,ps, 'complex')
    ...
    for complex_sentence, simple_sentence in yield_sentence_pair(complex_file_path, simple_file_path):
        ...
        #                                     top_n = 7, use_mmr = True,diversity = 0.5)
        # added = ''
