...
for phase in PHASES:
    ...
    complex_file = get_data_filepath(WIKI_DOC_FINAL, phase, 'complex')
    simple_file = get_data_filepath(WIKI_DOC_FINAL, phase, 'simple')
    ...
    for complex_sent, simple_sent in (yield_sentence_pair(complex_file, simple_file)):
        ...
        sent_num_comp += len(sent_tokenize(complex_sent))
        sent_num_sim += len(sent_tokenize(simple_sent))
        tot+=1
        print(tot)
...
print("wiki-doc total sentences in complex: ", sent_num_comp, "wiki-doc total sentences in simple: ", sent_num_sim)
print("wiki-doc total words in complex: ", word_num_comp, "wiki-doc total sentences in simple: ", word_num_sim)
print("wiki-doc avg sentences per document in complex: ", sent_num_comp/tot, "wiki-doc avg sentences per document in simple: ", sent_num_sim/tot)
'''
